...
import { useEditArticleForm } from "../hooks/useEditArticleForm";
...
const EditArticleForm = ({
  ...
  const {
    ...
    errors,
    isDirty,
  } = useEditArticleForm(articleId, initialValues);
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-1">
        <label
          htmlFor="edit-article-size"
          className="text-sm font-medium text-gray-700"
        >
          Taille
        </label>
        <input
          id="edit-article-size"
      ...
      <div className="flex flex-col space-y-1">
        <label
          htmlFor="edit-article-condition"
          className="text-sm font-medium text-gray-700"
        >
          État
        </label>
        <select
          id="edit-article-condition"
          {...register("condition", {
      ...
      <div className="flex flex-col space-y-1">
        <label
          htmlFor="edit-article-imageUrl"
          className="text-sm font-medium text-gray-700"
        >
          Image URL
        </label>
        <input
          id="edit-article-imageUrl"
          {...register("imageUrl", {
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:gap-3">
        ...
        <button
          ...
          disabled={isPending}
          className="w-full bg-gray-200 text-gray-800 font-semibold py-2 rounded-lg hover:bg-gray-300 transition disabled:opacity-50"
        >
          Annuler
        </button>
      </div>
